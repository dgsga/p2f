...
======================
This KEXT is a modified version of osy's original work which can be found  [here](https://github.com/osy/Polaris22Fixup). It fixes known graphics issues with Polaris22/VegaM on macOS. Only tested/supported on macOS Monterey 12.3+.
